...
function StoryCard({ image, title, description }) {
  return (
    <div>
      <div className="story-card-body h-[344px] relative group cursor-pointer overflow-hidden">
        <img
          src={image}
          alt=""
          className="w-full h-full object-cover group-hover:scale-125 transition-all"
        />
        <h2 className="hidden group-hover:block absolute -translate-x-[50%] top-[50%] left-[50%] text-white text-xl z-20">
          {title}
        </h2>
