...
const blogs = [
  ...
  {
    id: 2,
    title: "BESPOKE FURNITURE – A FURNITURE THAT MATCHES YOUR PERSONALITY!",
    description:
  ...
  },
  {
    ...
    description:
      "Silver Artifacts – An Epitome Of Artistry & Appeal  Silver as we all are famili...",
  ...
  },
  {
    ...
    description:
      "Tanjore Paintings – The Indian Heritage Artform That Stood The Test Of Time!  A rel...",
    ...
    jsx: (
      <div className="mt-12">
        ...
        <ul className="list-disc my-3">
          <li>
            <span className="font-bold">Perfect Lifestyle Requirement</span>–
          ...
          <li>
            <span className="font-bold">Best Materials</span>– High-quality
          ...
          <li>
            <span className="font-bold">Unique Design</span>– As we have already
          ...
          <li>
            <span className="font-bold">Stand Out in Crowd</span>– There is
